...
describe("Interpreter", function () {
    ...
    describe('Interpreter Facts', function () {
        ...
        it("add(two, two, four) should be true", function () {
            assert(interpreter.checkQuery("add(two, two, four)"));
        }); 
    ...
    describe('Interpreter Rules', function () {
        ...
        it("subtract(one, zero, one) should be true", function () {
            assert(interpreter.checkQuery("subtract(one, zero, one)"));
        });
